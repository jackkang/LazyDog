...
@interface firstAppModelController()
@property (readonly, strong, nonatomic) NSArray *pageData;
@end

@implementation firstAppModelController
...
{   
    ...
    firstAppDataViewController *dataViewController = [storyboard instantiateViewControllerWithIdentifier:@"firstAppDataViewController"];
...
{
    NSUInteger index = [self indexOfViewController:(firstAppDataViewController *)viewController];
